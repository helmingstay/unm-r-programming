## Build manuscript, output to writeup.html
## This should be readable by MS Word / LibreOffice

## weather file (data/abq-temps-2005-2015.csv.gz)
## generated by
# source('weather-scrape.R')
