...
temperatures at suitable time lags, and that low environmental temperatures are 
followed by modest increases in blockage frequency. We discuss the physical and
operational significance of these findings, and their applications to other 
localities.

### Drivers of Blockage
An extensive body of literature exists on sewer blockage mechanism [@block-mechanism],
physical structure [@block-structure] and detection [@detect].  
In addition, several large-scale studies have estimated drivers of SSB 
rates at the system level \@(large-scale). 
...
We also note that our system is a separate rather than a combined sanitary 
sewer system. Separate systems are commonly found in the U.S., whereas combined
sewers experience storm-driven flushing and are more common in Europe?? 
Furthermore, the U.S. has a higher prevalence of garbage disposal units, i.e., 
mechanical grinders that add food waste directly into the sewer system, 
than elsewhere (cite??). The lack of storm flows and the addition of ground food waste
likely contribute to the observed findings.  As such, an important test of our
