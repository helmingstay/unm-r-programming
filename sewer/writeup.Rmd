...
The physical structure of sewers varies greatly over both time
and space. Combined sewer systems (CSS) carry both storm water and
sanitary waste in a single sewer network, whereas separate sewer 
systems (SSS) use separate networks for each. Historically, CSSs 
